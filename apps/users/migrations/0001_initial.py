    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(upload_to=utils.upload.upload_instance, verbose_name='Аватар')),
                ('background_picture', models.ImageField(upload_to=utils.upload.upload_instance, verbose_name='Задний фон')),
