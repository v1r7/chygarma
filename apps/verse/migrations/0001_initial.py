# Generated by Django 3.2.2 on 2021-07-29 11:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_liked', models.ManyToManyField(related_name='likes', to='verse.Author', verbose_name='Лайки')),
                ('tags', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='verse.tag', verbose_name='Хэштэги')),
            ],
            options={
                'verbose_name': 'Стих',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comments_author', to='verse.author')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='profile_user', to='verse.author')),
